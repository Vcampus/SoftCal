...
//		}
	...
	private void initLayot() {
		...
		FormData textEM_fd= new FormData();
		textEM_fd.left = new FormAttachment(lblEM,10);
		textEM_fd.top = new FormAttachment(lblhorizontal1, 10);
		textEM.setLayoutData(textEM_fd);
